...
#elif defined(CC_PLATFORM_RISCV) || (defined(__riscv))

#    undef CC_PLATFORM_RISCV
#    define CC_PLATFORM_RISCV       1
...
#    else
#        define CC_CACHE_LINE_SIZE 16
#        warning riscv unknown cache line size
#    endif
...
#    else
#        define CC_CACHE_LINE_SIZE 16
#        warning xtensa unknown cache line size
#    endif
